...
def controls():
    ...
    return render_template('instructor/controls.html', course=json.dumps(get_schedule()), SCHEMA=SCHEMA, setString=setString, attend_list=attend_list, team_list=team_list, title='Controls')
