...
def getModels():
    ...
    chatbox = [None, ChatBox]
    attend = [None, Attendance]
    attl = [None, AttendLog]
    user = [None, User]
    units = [None, Units]
    exams = [None, Exams]
...
class User(db.Model, UserMixin):
    ...
    frd = db.Column(db.Integer)
    wpe = db.Column(db.Integer)
    icc = db.Column(db.Integer)
